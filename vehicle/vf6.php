<div class="main">
	<div id="color" class="vehicle-banner section container clearfix">
		<div class="basic">
			<p></p><h1>VF6</h1><p class="banner-price">Giá bán lẻ đề xuất (Đã bao gồm 10% VAT) <br/><span><?php echo number_format($cars[43][6])?></span> VNĐ</p>
		</div>
		<div class="color-360">
		...
		<ul id="vehicle_color_list" class="color-list">
			<li><img src="<?php echo $urlsite?>/images/product/vf6/360/089.png" post="<?php echo $post;?>" color="1"><span></span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/vf6/360/P20.png" post="<?php echo $post;?>" color="2"><span></span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/vf6/360/S28.png" post="<?php echo $post;?>" color="3"><span></span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/vf6/360/X12.png" post="<?php echo $post;?>" color="4"><span></span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/vf6/360/3Q3.png" post="<?php echo $post;?>" color="5"><span></span></a></li>
		</ul>
