<div class="main">
	<div id="color" class="vehicle-banner section container clearfix">
		...
		<ul id="vehicle_color_list" class="color-list">
			<li><img src="<?php echo $urlsite?>/images/product/avanza/360/W09.png" post="<?php echo $post;?>" color="1"><span>Trắng ngọc</span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/avanza/360/P20.png" post="<?php echo $post;?>" color="2"><span>Bạc tím</span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/avanza/360/S28.png" post="<?php echo $post;?>" color="3"><span>Bạc</span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/avanza/360/X12.png" post="<?php echo $post;?>" color="4"><span>Đen</span></a></li>
		...
		<div class="vehicle-share">
	        <div class="social-network">	            
						<a href="https://www.facebook.com/toyotavietnamquangninhtqn<?php echo $urlsite?>" class="facebook share-popup">Facebook</a> 
						...
						<a href="https://www.youtube.com/channel/UCOufMvS1vslunVPW1qPxlNQ" target="blank" class="youtube">YouTube</a>
	        </div>
	...
	<!-- Version -->
		...
		<div class="vehicle-version clearfix">		
			<ul class="slides">					
				<li class="item">
					<h3 class="name">Veloz Cross</h3>
					<p class="price clearfix"><?php echo number_format($cars[44][6])?> VNĐ<small>Giá Đã bao gồm 10% VAT</small></p>
					<div class="point"><img width="360" height="240" src="<?php echo $urlsite?>/images/product/price/gia_xe_avanza.png" alt="Avanza 1.5AT"><p>5 cửa, 7 chỗ ngồi, ghế nỉ cao cấp</p><p>Số tự động vô cấp</p><p>Động cơ xăng dung tích 1.5L</p></div>
				</li>
				<li class="item">
					<h3 class="name">Veloz Cross Top</h3>
					<p class="price clearfix"><?php echo number_format($cars[45][6])?> VNĐ<small>Giá Đã bao gồm 10% VAT</small></p>
					<div class="point"><img width="360" height="240" src="<?php echo $urlsite?>/images/product/price/gia_xe_avanza.png" alt="Avanza 1.5MT"><p>5 cửa, 7 chỗ ngồi, ghế nỉ cao cấp</p><p>Số sàn 5 cấp</p><p>Động cơ xăng dung tích 1.5L</p></div>
				</li>
				<!--<li class="item">
	...
	<div id="exterior" class="section container clearfix">
		...
		<div class="vehicle-slider">
			<ul class="slides clearfix">
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/avanza/exterior/ngoai_that_01.png">
					<div class="description clearfix"><p>TRONG TIỆN NGHI NGOÀI PHONG CÁCH</p>
</div>
				</li>
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/avanza/exterior/ngoai_that_02.png">
					<div class="description clearfix"><p>THIẾT KẾ MẠNH MẼ, HIÊN NGANG</p>
</div>
				</li>
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/avanza/exterior/ngoai_that_03.png">
	...
	<div id="interior" class="section container clearfix">
		<h2 class="section-title">Nội thất</h2>
			...
			<ul class="slides clearfix">
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/avanza/interior/noi_that_wigo1.png">
					<!--<div class="description clearfix"><p>Phấn khích như một chiếc xe thể thao</p>
</div>-->
				</li>
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/avanza/interior/noi_that_wigo2.png">
				</li>
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/avanza/interior/noi_that_wigo3.png">
				</li>d
			</ul>
		</div>
		<div class="image-note">
...
<!--
	...
	<!-- Video -->
		...
		<div class="vehicle-video">
			<ul class="slides">
				<li><iframe width="560" height="315" src="https://www.youtube.com/embed/5M2s9a7Z2tU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></li>
...
?>
	...
	<div class="container vehicle-next-steps clearfix">
		...
		<div class="vehicle-call-to-action">
			<a download href="<?php echo $urlsite?>/document/avanza/avanza_catalouge.pdf"><small>Tải về</small> Catalog Avanza</a>
		</div>
		<div class="vehicle-call-to-action">
