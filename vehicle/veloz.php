<div class="main">
	<div id="color" class="vehicle-banner section container clearfix">
		<div class="basic">
			<p></p><h1>VELOZ</h1><p class="banner-price">Giá bán lẻ đề xuất (Đã bao gồm 10% VAT) <br/><span><?php echo number_format($cars[43][6])?></span> VNĐ</p>
		</div>
		<div class="color-360">
		...
		<ul id="vehicle_color_list" class="color-list">
			<li><img src="<?php echo $urlsite?>/images/product/veloz/360/089.png" post="<?php echo $post;?>" color="1"><span>Trắng ngọc trai</span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/veloz/360/P20.png" post="<?php echo $post;?>" color="2"><span>Bạc tím</span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/veloz/360/S28.png" post="<?php echo $post;?>" color="3"><span>Bạc</span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/veloz/360/X12.png" post="<?php echo $post;?>" color="4"><span>Đen</span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/veloz/360/3Q3.png" post="<?php echo $post;?>" color="5"><span>Đỏ</span></a></li>
		</ul>
...
<!--
	...
	<!-- Video -->
		...
		<div class="vehicle-video">
			<ul class="slides">
				<iframe width="560" height="315" src="https://www.youtube.com/embed/OXkjYMFX5jc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
?>
	...
	<div class="container vehicle-next-steps clearfix">
		...
		<div class="vehicle-call-to-action">
			<a download href="<?php echo $urlsite?>/document/veloz/veloz_catalouge.pdf"><small>Tải về</small> Catalog Veloz</a>
		</div>
		<div class="vehicle-call-to-action">
