<div class="main">
	<div id="color" class="vehicle-banner section container clearfix">
		<div class="basic">
			<p></p><h1>WIGO</h1><p class="banner-price">Giá bán lẻ đề xuất (Đã bao gồm 10% VAT) <br/><span><?php echo number_format($cars[33][6])?></span> VNĐ</p>
		</div>
		<div class="color-360">
		...
		<ul id="vehicle_color_list" class="color-list">
			<li><img src="<?php echo $urlsite?>/images/product/wigo/360/R79.png" post="<?php echo $post;?>" color="1"><span>Đỏ</span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/wigo/360/R80.png" post="<?php echo $post;?>" color="2"><span>Cam</span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/wigo/360/S28.png" post="<?php echo $post;?>" color="3"><span>Bạc</span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/wigo/360/W09.png" post="<?php echo $post;?>" color="4"><span>Trắng</span></a></li>
	...
	<div id="interior" class="section container clearfix">
		<h2 class="section-title">Nội thất</h2>
			...
			<ul class="slides clearfix">
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/wigo/interior/noithat1.jpg">
					<!--<div class="description clearfix"><p>Phấn khích như một chiếc xe thể thao</p>
</div>-->
				</li>
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/wigo/interior/noithat2.jpg">
				</li>
...
?>
	...
	<div class="container vehicle-next-steps clearfix">
		...
		<div class="vehicle-call-to-action">
			<a download href="<?php echo $urlsite?>/document/wigo/wigo.pdf"><small>Tải về</small> Catalog Wigo</a>
		</div>
		<div class="vehicle-call-to-action">
