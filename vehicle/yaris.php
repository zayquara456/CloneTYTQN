<div class="main">
	<div id="color" class="vehicle-banner section container clearfix">
		<div class="basic">
			<p></p><h1>YARIs</h1><p class="banner-price">Giá bán lẻ đề xuất (Đã bao gồm 10% VAT) <br/><span><?php echo number_format($cars[0][6])?></span> VNĐ</p>
		</div>
		<div class="color-360">
		...
		<ul id="vehicle_color_list" class="color-list">
			<li><img src="<?php echo $urlsite?>/images/product/yaris/360/1D6.png" post="<?php echo $post;?>" color="1"><span>Bạc</span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/yaris/360/6W2.png" post="<?php echo $post;?>" color="2"><span>Vàng</span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/yaris/360/3R3.png" post="<?php echo $post;?>" color="3"><span>Đỏ</span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/yaris/360/040.png" post="<?php echo $post;?>" color="4"><span>Trắng</span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/yaris/360/1G3.png" post="<?php echo $post;?>" color="5"><span>Xám đậm</span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/yaris/360/218.png" post="<?php echo $post;?>" color="6"><span>Đen</span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/yaris/360/4R8.png" post="<?php echo $post;?>" color="7"><span>Cam</span></a></li>
		</ul>
	...
	<!-- Version -->
		...
		<div class="vehicle-version clearfix">		
			<ul class="slides">					
				<li class="item">
					<h3 class="name">Yaris G CVT</h3>
					<p class="price clearfix"><?php echo number_format($cars[0][6])?> VNĐ<small>Giá Đã bao gồm 10% VAT</small></p>
					<div class="point"><img width="360" height="240" src="<?php echo $urlsite?>/images/product/price/gia_xe_yaris.png" alt="Yaris G CVT"><p>5 cửa, 5 chỗ ngồi, ghế nỉ cao cấp</p><p>Số tự động vô cấp</p><p>Động cơ xăng dung tích 1496 cc</p></div>
				</li>
				<!--<li class="item">
	...
	<div id="exterior" class="section container clearfix">
		...
		<div class="vehicle-slider">
			<ul class="slides clearfix">
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/yaris/exterior/ngoai_that_yaris.png">
					<div class="description clearfix"><p>TRẺ TRUNG NỔI BẬT CÁ TÍNH</p>
</div>
				</li>
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/yaris/exterior/Yaris_p2-3.png">
	...
	<div id="interior" class="section container clearfix">
		<h2 class="section-title">Nội thất</h2>
			...
			<ul class="slides clearfix">
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/yaris/interior/noi_that.png">
					<!--<div class="description clearfix"><p>Phấn khích như một chiếc xe thể thao</p>
</div>-->
				</li>
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/yaris/interior/2.png">
				</li>
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/yaris/interior/3.png">
				</li>d
			</ul>
		</div>
		<div class="image-note">
...
?>
	...
	<div class="container vehicle-next-steps clearfix">
		...
		<div class="vehicle-call-to-action">
			<a download href="<?php echo $urlsite?>/document/yaris/yaris.pdf"><small>Tải về</small> Catalog Yaris</a>
		</div>
		<div class="vehicle-call-to-action">
