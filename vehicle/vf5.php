<div class="main">
	<div id="color" class="vehicle-banner section container clearfix">
		...
		<ul id="vehicle_color_list" class="color-list">
			<li><img src="<?php echo $urlsite?>/images/product/vf5/360/W09.png" post="<?php echo $post;?>" color="1"><span></span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/vf5/360/P20.png" post="<?php echo $post;?>" color="2"><span></span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/vf5/360/S28.png" post="<?php echo $post;?>" color="3"><span></span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/vf5/360/X12.png" post="<?php echo $post;?>" color="4"><span></span></a></li>
			<li><img src="<?php echo $urlsite?>/images/product/vf5/360/3Q3.png" post="<?php echo $post;?>" color="5"><span></span></a></li>
	...
	<!-- Version -->
		...
		<div class="vehicle-version clearfix">		
			<ul class="slides">					
				<li class="item">
					<h3 class="name">VF5 mua pin</h3>
					<p class="price clearfix"><?php echo number_format($cars[44][6])?> VNĐ<small>Giá Đã bao gồm 10% VAT</small></p>
					<div class="point"><img width="360" height="240" src="<?php echo $urlsite?>/images/product/price/gia_xe_vf5.jpg" alt="VF5"><p>5 cửa, 5 chỗ ngồi</p><p>Công suất tối đa: 134 hp</p><p> Dung lượng pin khả dụng: 37,23 Kwh</p></div>
				</li>
				<li class="item">
					<h3 class="name">VF5 thuê pin</h3>
					<p class="price clearfix"><?php echo number_format($cars[45][6])?> VNĐ<small>Giá Đã bao gồm 10% VAT</small></p>
					<div class="point"><img width="360" height="240" src="<?php echo $urlsite?>/images/product/price/gia_xe_vf5.jpg" alt="VF5"><p>5 cửa, 5 chỗ ngồi</p><p>Công suất tối đa: 134 hp</p><p>Dung lượng pin khả dụng: 37,23 Kwh</p><p>Gói thuê pin chỉ từ: 1.400.000 VNĐ/tháng.</p></div>
				</li>
			</ul>			
		</div>
	</div>
	...
	<div id="exterior" class="section container clearfix">
		...
		<div class="vehicle-slider">
			<ul class="slides clearfix">
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/vf5/exterior/ngoai_that_01.png">
					<div class="description clearfix"><p>TRONG TIỆN NGHI NGOÀI PHONG CÁCH</p>
</div>
				</li>
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/vf5/exterior/ngoai_that_02.png">
					<div class="description clearfix"><p>THIẾT KẾ MẠNH MẼ, HIÊN NGANG</p>
</div>
				</li>
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/vf5/exterior/ngoai_that_03.png">
	...
	<div id="interior" class="section container clearfix">
		<h2 class="section-title">Nội thất</h2>
			...
			<ul class="slides clearfix">
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/vf5/interior/noi_that_wigo1.png">
					<!--<div class="description clearfix"><p>Phấn khích như một chiếc xe thể thao</p>
</div>-->
				</li>
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/vf5/interior/noi_that_wigo2.png">
				</li>
				<li class="left top">
					<img src="<?php echo $urlsite?>/images/product/vf5/interior/noi_that_wigo3.png">
				</li>d
			</ul>
		</div>
		<div class="image-note">
...
?>
	...
	<div class="container vehicle-next-steps clearfix">
		...
		<div class="vehicle-call-to-action">
			<a download href="<?php echo $urlsite?>/document/vf5/vf5.pdf"><small>Tải về</small> Catalog VF5</a>
		</div>
		<div class="vehicle-call-to-action">
