<div class="main">
	<div id="home_slider" class="home-slider">
		<ul class="slides">
			...
			<div><a href="http://toyota.quangninh.vn"><img class="owl-lazy" src="<?php echo $urlsite?>/images/slide/10.21_raize.jpeg"/></a></div>
		</li>

			<li class="flex-active-slide" style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 1; display: block; z-index: 2;">
			<div><a href="http://toyota.quangninh.vn/"><img class="owl-lazy" src="<?php echo $urlsite?>/images/slide/10.21_vios.jpeg"/></a></div>
		</li>

			<li class="flex-active-slide" style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 1; display: block; z-index: 2;">
			<div><a href="http://toyota.quangninh.vn/tin-tuc-su-kien/toyota-viat-nam-giai-thiau-land-cruiser-tha-ha-mai-nhan-dap-ka-niam-70-nm.html"><img class="owl-lazy" src="<?php echo $urlsite?>/images/slide/10.21_fortuner.jpeg"/></a></div>
		</li>
		
		<li class="flex-active-slide" style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 1; display: block; z-index: 2;">
			<div><a href="http://toyota.quangninh.vn/wigo/"><img class="owl-lazy" src="<?php echo $urlsite?>/images/slide/10.21_altis.jpeg"/></a></div>
		</li>
		
		<li class="flex-active-slide" style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 1; display: block; z-index: 2;">
			<div><a href="http://toyota.quangninh.vn//"><img class="owl-lazy" src="<?php echo $urlsite?>/images/slide/10.21_dichvu.jpeg"/></a></div>
		</li>
		...
		<div class="container clearfix">
			<div class="column video">
				<div class="video-wrapper">
					<iframe width="560" height="315" src="https://www.youtube.com/embed/ebC-m3-bpfI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
			<div class="column feeds">
				<div class="item facebook">
					...
					<h3><a href="https://www.facebook.com/PhongToyotaQuangNinh" target="blank">ToyotaQuangNinh's fanpage</a></h3>
					<p>Facebook chính thức của Toyota Quảng Ninh. Dành cho mọi người yêu và quan tâm đến xe hơi và thương hiệu Toyota.</p>
					<div class="plugin">
				...
				<div class="item youtube">
					...
					<h3><a href="https://www.youtube.com/channel/UCOufMvS1vslunVPW1qPxlNQ?view_as=subscriber" target="blank">Toyota Vietnam's channel</a></h3>
					<p>Tìm hiểu thêm về sản phẩm của Toyota Việt Nam qua các video giới thiệu của chúng tôi.</p>
					<div class="plugin">
				...
				<div class="item twitter">
					...
					<p>Theo dõi Toyota Việt Nam trên Twitter.</p>
					<div class="plugin">
