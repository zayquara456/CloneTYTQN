<div class="main">
	<div id="home_slider" class="home-slider">
		...
		<li>
			<div><a href="http://toyota.quangninh.vn/tin-tuc-su-kien/toyota-vios-2020-ba-sung-nhiau-tanh-nng-mai-xe-giao-ngay-thang-12020.html"><img class="owl-lazy" src="<?php echo $urlsite?>/images/slide/HomepageBanner.png"/></a></div>
		</li>
		<li>
			<div><a href="#"><img class="owl-lazy" src="<?php echo $urlsite?>/images/slide/khuyen_mai_112019.jpg"/></a></div>
		</li>
		<li>
		...
		<div class="container clearfix">
			<div class="column video">
				<div class="video-wrapper">
					<iframe width="100%" height="326" src="//www.youtube.com/embed/dj74PVH2LW4" frameborder="0" allowfullscreen></iframe>
				</div>
			</div>
			<div class="column feeds">
				<div class="item facebook">
					<a class="favicon" target="blank" href="http://facebook.com/toyotaquangninhdaily" title="Toyota Vietnam on Facebook">Facebook</a>
					<h3><a href="http://facebook.com/toyotaquangninhdaily" target="blank">ToyotaQuangNinh's fanpage</a></h3>
					<p>Facebook chính thức của Toyota Quảng Ninh. Dành cho mọi người yêu và quan tâm đến xe hơi và thương hiệu Toyota.</p>
					<div class="plugin">
						<div class="fb-like" data-href="http://facebook.com/toyotavietnam" data-width="100%" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
					</div>
				</div>
				<div class="item youtube">
					<a class="favicon" target="blank" href="http://youtube.com/toyotavietnam" title="Toyota Vietnam on YouTube">YouTube</a>
					<h3><a href="http://youtube.com/toyotavietnam" target="blank">Toyota Vietnam's channel</a></h3>
