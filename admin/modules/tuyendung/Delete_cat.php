...
$result = $db->sql_query("SELECT catid, parent FROM {$prefix}_tuyendung_cat WHERE alanguage='$currentlang' ORDER BY weight, catid ASC");
...
$query = "SELECT time, images FROM ".$prefix."_tuyendung WHERE $condition";
...
$query = "DELETE FROM {$prefix}_tuyendung WHERE $condition";
$db->sql_query($query);
$query = "DELETE FROM {$prefix}_tuyendung_cat WHERE $condition";
$db->sql_query($query);

truncate_table("tuyendung_cat");
fixweight_cat();
