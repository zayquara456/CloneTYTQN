...
$result = $db->sql_query("SELECT id, newsid, title, content, name, email, time, status FROM {$prefix}_document_comments WHERE alanguage='$currentlang' $sortby LIMIT $offset, $perpage");
