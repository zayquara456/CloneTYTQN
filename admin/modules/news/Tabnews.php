...
if(isset($_POST['subup']) && $_POST['subup'] == 1) {
	...
	if(!$err) {
		$weight = WeightMax("news_tab");
		$db->sql_query("INSERT INTO ".$prefix."_news_tab (tabid, newsid, title, content, alanguage, weight) VALUES (NULL, '$newsid', '$title', '$content', '$currentlang', '$weight')");
		fixweight_newstab();
...
echo "<td align=\"center\" class=\"row1\"><a href=\"?f=$adm_modname&do=tabedit&newsid=$newsid&tabid=$tabid\" info=\""._EDIT."\"><img border=\"0\" src=\"images/edit.png\"></a></td>\n";
