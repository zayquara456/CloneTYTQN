...
if(isset($_POST['submit'])) {
	...
	if($db->sql_numrows($result) > 0) {
		$db->sql_query("UPDATE ".$prefix."_gentext SET content='$content' WHERE textname='telecom' AND alanguage='$currentlang'");
	}else{
		$db->sql_query("INSERT INTO ".$prefix."_gentext (textname, content, alanguage) VALUES ('telecom', '$content', '$currentlang')");
	}
