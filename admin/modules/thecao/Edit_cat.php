...
echo "<tr><td colspan=\"2\" class=\"header\">Chỉnh sửa loại thẻ</td></tr>";
echo "<tr>\n";
...
echo "</tr>\n";
if($parentid != 0) {
	$result_cat = $db->sql_query("SELECT catid, title FROM ".$prefix."_thecao_cat WHERE parentid='0' AND catid!='$catid' AND alanguage='$currentlang' ORDER BY weight");
