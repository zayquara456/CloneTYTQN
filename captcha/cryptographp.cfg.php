...
$cryptwidth  = 60;  // Largeur du cryptogramme (en pixels)
$cryptheight = 26;   // Hauteur du cryptogramme (en pixels)

$bgR  = 0;         // Couleur du fond au format RGB: Red (0->255)
$bgG  = 0;         // Couleur du fond au format RGB: Green (0->255)
$bgB  = 0;         // Couleur du fond au format RGB: Blue (0->255)
...
$charsizemax = 10;      // Taille maximum des caractères
...
$brushsize = 2;        // Taille d'ecriture du princeaiu (en pixels) 
