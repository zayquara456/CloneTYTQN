...
<div class="comments">
	...
	<div style="padding-top: 0px;" class="adword adword-middle"><div style="font-family: arial; font-weight: bold; font-size: 12px; color: #ff0000"><?php echo $err_title ?></div>
			...
			<div style="padding-top: 0px;" class="adword-nav2 fl">
				<textarea style="width: 625px;" class="SForm" onkeyup="initTyper(this)" id="txtAddedContent" name="txtAddedContent" rows="5"></textarea>		
			</div>
			<div style="text-align:right; padding-right: 20px"><input type="Submit" class="SForm" name="B1" value="Gửi bình luận"></div>
