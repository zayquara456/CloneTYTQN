...
<link rel="StyleSheet" href="templates/Adoosite/css/download_styles.css" type="text/css">
</head>
<body bgcolor="#CCCCCC">
<div id="maincontainer">
	<div id="topsection">
		<div id="logo fl"><img src="<?php echo $imgFold.'/logo_acud.png';?>"></div>
		<div id="adv_topdownload"></div>
		<div class="cl"></div>
	</div>
	<div id="contentwrapper">
		<div id="contentleft fl"></div>
		<div id="contentcolumn fl"></div>
	</div>
</div>
<?php
if(!$err){
