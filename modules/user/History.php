...
if(isset($_POST['delete']) && $_POST['delete'] !="") {
	$idx = $_POST['id'];
	foreach ($idx as $id) {
		$db->sql_query("DELETE FROM ".$prefix."_user_log WHERE id='$id'");	
	}		
...
echo "<td class=\"row1sd\" width=\"50\">Thời gian</td>\n";
...
echo "<td class=\"row2sd\"  width=\"200\" >Mô tả</td>\n";
echo "</tr>\n";
...
if($total > $perpage) {
	echo "<div class=\"fr\">";	
	$pageurl = "index.php?f=user&do=history";
