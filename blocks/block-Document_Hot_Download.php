...
$margin="";
$content ="";
$result_lastnew = $db->sql_query("SELECT n.id, n.title, n.images, n.time, n.hometext, n.hits, n.hits_download, u.folder, u.fullname FROM ".$prefix."_document AS n, ".$prefix."_user AS u WHERE  n.active=1 AND n.alanguage='$currentlang'  AND n.user_id=u.id ORDER BY n.hits_download DESC LIMIT 18");
