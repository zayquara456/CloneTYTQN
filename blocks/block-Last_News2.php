...
$result_lastnew = $db->sql_query("SELECT id, title, images, time, hometext FROM ".$prefix."_news WHERE active='1' AND catid=54 AND alanguage='$currentlang' $seld ORDER BY hits DESC LIMIT 6");
