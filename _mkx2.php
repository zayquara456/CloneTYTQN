...
$phone=nospatags($nummobile);
	...
	if (!$err) {
			$db->sql_query("UPDATE {$prefix}_user SET pass2='".md5($password)."' WHERE phone='$phone'");
			$responseInfo = "Ban da doi mat khau cap 1 thanh cong.\n";
			$responseInfo = $responseInfo."MK2 ".$password."\n";
