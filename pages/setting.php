...
$title_tag 	= 'TOYOTA QUẢNG NINH - BẢNG GIÁ, KHUYẾN MẠI 2021 TOYOTA VIỆT NAM';
...
switch ($page) {
    ...
    case "vehicle-corolla-altis":
		...
		$description_tag = 'Xe ô tô Toyota Corolla Altis là mẫu sedan hạng C cỡ trung được khách hàng Việt rất tin cậy và yêu thích. Giá xe Toyota Altis 2021 mới tốt nhất liên hê:'.$hotline;
        break;
	case "vehicle-camry":
	...
	case "vehicle-hiace":
        ...
        break;
	case "bang-gia-xe":
        $title_tag = "BẢNG GIÁ XE MỚI NHẤT 2023 TOYOTA QUẢNG NINH";
		$description_tag = 'Giá xe Toyota Vios, Camry, Corolla Altis, Innova năm 2021 tại quảng ninh. Giá tốt nhất, mua xe chỉ cần 100tr-300tr. liên hê:'.$hotline;
        break;
	case "du-toan-chi-phi":
        $title_tag = "Bảng tính dự toán chi phí mua xe Toyota Tại Quảng Ninh 2021";
		$description_tag = 'Bảng tính dự toán chi phí mua xe Toyota Vios, Camry, Corolla Altis, Innova năm 2021 tại quảng ninh. mua xe chỉ cần 100tr-300tr. liên hê:'.$hotline;
        break;
	case "cach-tinh-lai-suat-cho-vay-mua-xe-oto-tra-gop":
        $title_tag = "Cách tính mua xe trả góp xe Toyota Tại Quảng Ninh 2021";
		$description_tag = 'Cách tính mua xe trả góp xe Toyota Vios, Camry, Corolla Altis, Innova, fortuner năm 2021 tại quảng ninh. mua xe chỉ cần 100tr-300tr. liên hê:'.$hotline;
        break;
...
$cars = array
  ...
  array(0,"yaris","YG","Yaris G (CVT)","NSP151L-AHXGKU","CBU",668000000,480700),
  array(1,"yaris","YE","Yaris E (CVT)","NSP151L-AHXRKU","CBU",592000000,480700),
  array(2,"vios","VG","Vios G (CVT)","NSP151L-BEXGKU","CKD",581000000,480700),
  array(3,"vios","VE","Vios E (CVT)","NSP151L-BEXGKU","CKD",540000000,480700),
  array(4,"vios","VK","Vios E (CVT)","NSP151L-BEMRKU","CKD",531000000,480700),
  array(5,"vios","VE","Vios E (MT)","NSP151L-BEMRKU","CKD",478000000,480700),
  ...
  array(8,"corolla","CV","Corolla Altis 1.8G (CVT)","ZRE173L-GEXVKH","CKD",763000000,480700),
  ...
  array(14,"innova","IV","Innova 2.0V","ASV50L-JETEKU","CKD",989000000,837400),
  array(15,"innova","IG","Innova 2.0G","ASV50L-JETEKU","CKD",865000000,837400),
  array(16,"innova","IE","Innova 2.0E","ASV50L-JETEKU","CKD",750000000,837400),
  //array(16,"innova","IJ","Innova 2.0J","ASV50L-JETEKU","CKD",712000000,837400),
  array(17,"fortuner","FV","Fortuner 2.8AT 4x4","ASV50L-JETEKU","CKD",1396000000,837400),
  array(18,"fortuner","FX","Fortuner 2.7AT 4x2","ASV50L-JETEKU","CBU",1154000000,837400),
  array(19,"fortuner","FG","Fortuner 2.4MT 4x2","ASV50L-JETEKU","CKD",995000000,837400),
  array(20,"land","LC","Land Cruiser VX","ASV50L-JETEKU","CBU",4060000000 ,837400),
  array(21,"prado","LP","Land Cruiser Prado TX-L","ASV50L-JETEKU","CBU",2548000000,837400),
  array(22,"hilux","HQ","Hilux 2.8G 4x4 AT","ASV50L-JETEKU","CBU",913000000,1026300),
  array(23,"hilux","HG","Hilux 2.4E 4x4 MT","ASV50L-JETEKU","CBU",799000000,1026300),
  array(24,"hilux","HK","Hilux 2.4E 4x2 AT","ASV50L-JETEKU","CBU",674000000,1026300),
  ...
  array(29,"fortuner","FK","Fortuner 2.4AT 4x2","ASV50L-JETEKU","CBU",1080000000,837400),
  array(30,"fortuner","FKS","Fortuner Legender 2.4AT 4x2","ASV50L-JETEKU","CKD",1195000000,837400),
  array(31,"hilux","HE","Hilux 2.4E 4x2 MT","ASV50L-JETEKU","CBU",628000000,1026300),
  array(32,"wigo","WE","Wigo 1.2E MT","B101LA-GMSGF","CBU",352000000,480700),
  array(33,"wigo","WG","Wigo 1.2G AT","B101LA-GMSGF","CBU",385000000,480700),
  array(34,"cross","CXH","Coralla Cross 1.8HV","ZVG10L-DHXEBU","CBU",910000000,837400),
  array(35,"cross","CXV","Coralla Cross 1.8V","ZSG10L-DHXEKU","CBU",820000000,837400),
  array(36,"cross","CXG","Coralla Cross 1.8G","ZSG10L-DHXNKU","CBU",720000000,837400),
  array(37,"fortuner","FVS","Fortuner Legender 2.8AT 4x4","ASV50L-JETEKU","CKD",1426000000,837400),
  array(38,"fortuner","FV","Fortuner 2.7AT 4x4","ASV50L-JETEKU","CKD",1244000000,837400),
  array(39,"vios","VGS","Vios GR-S (CVT)","NSP151L-BEMRKU","CKD",630000000,480700),
  array(40,"raize","RZ","Raize 1.0 (CVT)","B101LA-GMSGF","CBU",527000000,480700)
  );
 $locations = array
  (
